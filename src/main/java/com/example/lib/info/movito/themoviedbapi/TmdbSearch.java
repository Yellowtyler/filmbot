...
import com.example.lib.info.movito.themoviedbapi.model.Collection;
import com.example.lib.info.movito.themoviedbapi.model.Company;
import com.example.lib.info.movito.themoviedbapi.model.Multi;
...
import static com.example.lib.info.movito.themoviedbapi.TmdbCollections.TMDB_METHOD_COLLECTION;
import static com.example.lib.info.movito.themoviedbapi.TmdbLists.TMDB_METHOD_LIST;
...
public class TmdbSearch extends AbstractTmdbApi {
     ...
     */
    public MovieResultsPage searchMovie(String query, Integer searchYear, String language, boolean includeAdult, Integer page, String region) {
